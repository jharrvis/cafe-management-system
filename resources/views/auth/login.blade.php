<x-guest-layout>
    ...
    <div class="min-h-screen w-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center p-4">
        ...
        <div class="w-full max-w-[414px] bg-gradient-to-br from-blue-500 to-purple-600 rounded-[40px] overflow-hidden shadow-2xl">
            <!-- Fullscreen Mobile App Layout -->
            <div class="min-h-[892px] w-full bg-gradient-to-br from-blue-500 to-purple-600 flex flex-col">
